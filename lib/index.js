...
client.on('guildMemberAdd', member => {
    if (JoinAndLeaveLog !== null) {
        JoinAndLeaveLog.sendMessage(":information_source: " + member.user.username + " **has joined " + member.guild.defaultChannel.guild.name + "\n**" + 
...
client.on('guildMemberRemove', member => {
    if (JoinAndLeaveLog !== null) {
        JoinAndLeaveLog.sendMessage(":warning: " + member.user.username + " **has left " + member.guild.defaultChannel.guild.name + "\n**" + 
                                    "[USER ID: " + member.user.id + "]");
    }
});
...
client.on('messageDelete', message => {
    if (MessageDeleteLog !== null) {
        MessageDeleteLog.sendMessage(":warning: **Message has been deleted from " + message.channel.guild.name + "\n" +
...
client.on('messageUpdate', message, NewMsg => {
    if (MessageEditLog !== null) {
        MessageEditLog.sendMessage(":warning: **Message has been edited from " + message.channel.guild.name + "\n" +
                "          **User:** <@" + message.author.id + "> \n" +
                "          **Channel:** " + message.channel + " \n" +
...
client.on('guildMemberUpdate', OldGuild, NewGuild => {
    if (NameChangeLog !== null) {
        if (OldGuild.user.username !== NewGuild.user.username) {
            NameChangeLog.sendMessage(":warning: " + OldGuild.user.username + " **has changed their username to " + NewGuild.user.username + "**");
        }
        if (OldGuild.user.nickname !== NewGuild.user.nickname) {
            NameChangeLog.sendMessage(":warning: " + OldGuild.user.username + " **has changed their nickname.**\n" + 
                                    "          **Old Nickname:** " + OldGuild.user.nickname + "\n" + 
                                    "          **New Nickname:** " + NewGuild.user.nickname + "\n");
        }
    }
});
...
client.on('ready', () => {
    ...
    client.channels.get('310787999862620171').sendMessage('@here\w:white_check_mark: **Electro-Atom Bot on duty!**')
