...
var JoinAndLeaveLog = client.channels.get('310791614924587032')
var MessageDeleteLog = client.channels.get('310791925617917962')
var MessageEditLog = client.channels.get('310792396814155776')
var NameChangeLog = client.channels.get('310794181905743872')
...
client.on('messageUpdate', (oldMessage, newMessage) => {
    if (MessageEditLog !== null) {
        MessageEditLog.sendMessage(":warning: **Message has been edited from " + oldMessage.channel.guild.name + "\n" +
...
client.on('guildMemberUpdate', (oldMember, newMember) => {
    if (NameChangeLog !== null) {
        if (oldMember.user.username !== newMember.user.username) {
            NameChangeLog.sendMessage(":warning: " + oldMember.user.username + " **has changed their username to " + newMember.user.username + "**");
        }
        if (oldMember.user.nickname !== newMember.user.nickname) {
            NameChangeLog.sendMessage(":warning: " + oldMember.user.username + " **has changed their nickname.**\n" + 
