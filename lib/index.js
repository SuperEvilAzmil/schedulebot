...
client.on('ready', () => {
    ...
    console.log(client.channels.get('309855730117115905').attachments)
    console.log(client.channels.get('309855798006382592').attachments)
});
...
client.on('message', message => {
    ...
    else if (message.content.toLowerCase().match("fatherball")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
    ...
    else if (message.content.toLowerCase().match("father ball")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("f@therball")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("f@ther ball")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("f@therb@ll")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("f@ther b@ll")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("fatherb@ll")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
    ...
    else if (message.content.toLowerCase().match("father b@ll")) {                                        //Fatherball eliminator
        message.delete()
        message.channel.sendMessage("<@" + message.author.id + "> \n" +
                                    "**THIS JOKE SHOULD ALREADY OVER, YOU IDIOT**")
        DMOwner(":warning: **Suspicious Message Detected!** \n" +
