...
client.on('guildMemberAdd', member => {
    if (LogChannel !== null) {
        LogChannel.sendMessage(':information_source: ' + member.user.name + ' **has joined ' + member.guild.defaultChannel.guild.name + ' **');
    }
});

client.on('guildMemberRemove', member => {
    if (LogChannel !== null) {
        LogChannel.sendMessage(':warning: ' + member.user.name + ' **has left ' + member.guild.defaultChannel.guild.name + ' **');
    }
});
