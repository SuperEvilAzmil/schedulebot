...
client.on('guildMemberAdd', member => {
    if (JoinAndLeaveLog !== null) {
        client.channels.get(JoinAndLeaveLog).sendMessage(":information_source: **" + member.user.username + " has joined " + member.guild.defaultChannel.guild.name + "\n [USER ID: " + member.user.id + "]**");
    }
});

client.on('guildMemberRemove', member => {
    if (JoinAndLeaveLog !== null) {
        client.channels.get(JoinAndLeaveLog).sendMessage(":warning: **" + member.user.username + " has left " + member.guild.defaultChannel.guild.name + "\n [USER ID: " + member.user.id + "]**");
    }
});
...
client.on('messageUpdate', (oldMessage, newMessage) => {
    ...
    if (MessageEditLog !== null) {
        client.channels.get(MessageEditLog).sendMessage(":warning: **Message has been edited from " + oldMessage.channel.guild.name + "\n**" +
...
client.on('guildMemberUpdate', (oldMember, newMember) => {
    ...
    if (NameChangeLog !== null) {
        console.log(oldMember.user.nickname)
        console.log(newMember.user.nickname)
        ...
        if (oldMember.user.nickname !== newMember.user.nickname) {
            client.channels.get(NameChangeLog).sendMessage(":warning: " + oldMember.user.username + " **has changed their nickname.**\n" + 
                                    "          **Old Nickname:** " + oldMember.user.nickname + "\n" + 
                                    "          **New Nickname:** " + newMember.user.nickname + "\n");
        }
    }
});
...
client.on('ready', () => {
    ...
    client.channels.get('310787999862620171').sendMessage('@here\n:white_check_mark: **Electro-Atom Bot on duty!**')
