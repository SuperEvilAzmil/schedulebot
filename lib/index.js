...
client.on('guildMemberAdd', member => {
    if (LogChannel !== null) {
        LogChannel.sendMessage(':information_source: **A new user has joined**');
    }
});
 
client.on('ready', () => {
    DMOwner(':information_source: **Electro-Atom Bot operational**')
    console.log('Electro-Atom Bot on duty');
    console.log(client.channels.get('228252059181383683'))
});
